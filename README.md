...
BeaconAI includes **55 automated test fixtures** validating deterministic regex parsers, prompt injection defenses, circuit-breaker states, model-agnostic routing, sandboxed ATS vector PDF rendering, recruiter-friendly filenaming, dynamic role selection, and transactional email security:
...
tests/test_evaluator.py::test_tier1_rejects_keyword_physical_restriction PASSED [  7%]
tests/test_evaluator.py::test_tier1_rejects_hourly_pay_floor_violation PASSED [  9%]
tests/test_evaluator.py::test_tier1_rejects_schedule_conflict PASSED     [ 10%]
tests/test_evaluator.py::test_tier1_passes_qualified_job PASSED          [ 12%]
tests/test_evaluator.py::test_tier2_heuristic_matches_aligned_role PASSED [ 14%]
tests/test_evaluator.py::test_circuit_breaker_caps_evaluations PASSED    [ 16%]
tests/test_evaluator.py::test_extract_compensation_single_dollar_range PASSED [ 18%]
tests/test_evaluator.py::test_extract_compensation_salary_shorthand_and_ranges PASSED [ 20%]
tests/test_evaluator.py::test_idiomatic_ladder_not_rejected PASSED       [ 21%]
tests/test_evaluator.py::test_physical_ladder_rejected PASSED            [ 23%]
tests/test_evaluator.py::test_circuit_breaker_sets_deferred_and_eligible_for_rescan PASSED [ 25%]
tests/test_evaluator.py::test_has_llm_credentials_multi_provider PASSED  [ 27%]
...
tests/test_evaluator.py::test_tier1_rejects_commute_distance_exceeding_max PASSED [ 34%]
tests/test_evaluator.py::test_tier1_allows_remote_job_regardless_of_distance PASSED [ 36%]
tests/test_evaluator.py::test_tier2_heuristic_scores_dynamic_tags PASSED [ 38%]
tests/test_generator.py::test_blocked_url_fetcher_prevents_ssrf_and_lfi PASSED [ 40%]
tests/test_generator.py::test_export_markdown_to_pdf_generates_valid_pdf PASSED [ 41%]
tests/test_generator.py::test_export_markdown_to_pdf_blocks_remote_image_ssrf PASSED [ 43%]
tests/test_generator.py::test_export_markdown_to_pdf_blocks_local_file_lfi PASSED [ 45%]
tests/test_generator.py::test_export_markdown_to_pdf_decomposes_inline_dangerous_tags PASSED [ 47%]
tests/test_generator.py::test_scan_fault_tolerance_on_artifact_error PASSED [ 49%]
tests/test_generator.py::test_dynamic_role_and_project_selection_by_tags PASSED [ 50%]
tests/test_generator.py::test_dynamic_geographic_education_heuristics PASSED [ 52%]
tests/test_generator.py::test_scan_multi_feed_cli_and_target_feed_urls PASSED [ 54%]
tests/test_generator.py::test_generate_clean_resume_filename PASSED      [ 56%]
tests/test_generator.py::test_extract_company_from_title PASSED          [ 58%]
tests/test_generator.py::test_resume_template_removes_watermark_and_formats_education PASSED [ 60%]
tests/test_generator.py::test_narrative_context_does_not_bleed_into_tech_job PASSED [ 61%]
tests/test_ingestion.py::test_sanitize_html_strips_scripts_and_styles PASSED [ 63%]
tests/test_ingestion.py::test_sanitize_html_strips_hidden_elements PASSED [ 65%]
tests/test_ingestion.py::test_sanitize_html_removes_zero_width_chars PASSED [ 67%]
tests/test_ingestion.py::test_wrap_untrusted_content_boundaries PASSED   [ 69%]
...
tests/test_ingestion.py::test_slug_uniqueness_for_identical_titles PASSED [ 74%]
tests/test_ingestion.py::test_fetch_feed_enforces_byte_limit PASSED      [ 76%]
tests/test_notifier.py::test_extract_mailto_from_outreach PASSED         [ 78%]
tests/test_notifier.py::test_extract_mailto_nonexistent_file PASSED      [ 80%]
tests/test_notifier.py::test_build_notification_html PASSED              [ 81%]
tests/test_notifier.py::test_email_alignment_renders_table_container PASSED [ 83%]
tests/test_notifier.py::test_button_routing_direct_email PASSED          [ 85%]
tests/test_notifier.py::test_button_routing_no_email_portal PASSED       [ 87%]
tests/test_notifier.py::test_extract_target_email_from_description_and_raw_text PASSED [ 89%]
...
======================= 55 passed, 30 warnings in 2.61s ========================
```
